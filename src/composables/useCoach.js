      ...
      if (coach) {
        ...
        try {
          ...
          bookings.value.forEach(b => {
            if (b.userProfileId && !uniqueClients[b.userProfileId]) {
              uniqueClients[b.userProfileId] = {
                id: b.userProfileId,
                name: `Cliente #${b.userProfileId}`,
                bookingsCount: 1,
                lastBooking: b.schedule
              }
            } else if (b.userProfileId) {
              uniqueClients[b.userProfileId].bookingsCount++
            }
          })
